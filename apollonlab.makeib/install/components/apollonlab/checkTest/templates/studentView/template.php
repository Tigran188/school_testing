    ...
    <div class="modalWindow">
        ...
        <div class="top">
            ...
            <div class="timeStartEnd">
                ...
                <div class="timeCount">
                    <span class="arial">00:30:00</span>
                    /
                    <span class="arial">00:40:00</span>
                </div>
            </div>
        </div>
        <div class="test">
                            ...
                            <li>
                                <div class="d-flex">
                                    ...
                                    <div class="point arial">
                                        ...
                                        if(sort($question['QUESTION_INFO']['CORRECT']) == sort($question['SELECTED'])){
                                            echo $pointGiven;
                                        } else {
                                            echo 0;
...
<!--                                </div>-->
                        ...
                        case "CORRECT_MISTAKE":
                            ...
                            <textarea name="textWithMistake" disabled>
                                <?=$question['SELECTED'][0]?>
                            </textarea>
                                </div>
